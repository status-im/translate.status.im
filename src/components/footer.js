    ...
    return (
      <footer>
          ...
          <div className="footer-inline">
            <div className="inner footer-inline social-margin">
              <div className="flex">
                ...
                <div className="inner footer-inline">
                    <a href="https://discuss.status.im/" target="_blank">Discuss</a>
            ...
            <div className="inner footer-inline social-margin">
              <div className="flex">
                ...
                <div className="inner footer-inline">
                    <a href="http://get.status.im/chat/public/status" target="_blank">Status</a>
            ...
            <div className="inner footer-inline social-margin">
              <div className="flex">
                ...
                <div className="inner footer-inline">
                    <a href="http://get.status.im/chat/public/status" target="_blank">Twitter</a>
            ...
            <div className="inner footer-inline social-margin">
              <div className="flex">
                ...
                <div className="inner footer-inline">
                    <a href="http://get.status.im/chat/public/status" target="_blank">Github</a>
        ...
        <div className="footer-bottom">
          <a href="https://www.iubenda.com/privacy-policy/94457202" target="_blank">Privacy Policy</a>
        </div>
      </footer>
    );
  }
