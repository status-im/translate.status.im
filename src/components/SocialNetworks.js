...
export function DiscussSVG(props) {
  return (
    <svg width="26px" height="26px" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M0 12.7736C0 5.71653 5.9951 0 13.1103 0C20.2313 0 26 5.93706 26 12.9943C26 20.0514 20.2313 25.9885 13.1103 25.9885L0.00580125 26L0 12.7736ZM9.84279 19.7264C10.8004 20.1791 11.874 20.4287 13 20.4287C17.1031 20.4287 20.4285 17.1031 20.4285 13C20.4285 8.89685 17.1031 5.57143 13 5.57143C8.89688 5.57143 5.57143 8.89685 5.57143 13C5.57143 14.2826 5.89643 15.4898 6.46518 16.5402L5.13615 20.8929L9.84279 19.7264Z"
        fill="white"
      />
    </svg>
  );
  ...
  return (
    <Social>
      {socialNetworks.map(social => {
        const socialName = social.id;
        const SVGImage = social.svgImage;
        return (
          <SocialWrapper key={socialName}>
            <SocialContent>
              <SocialImgWrapper>
                <SVGImage />
              </SocialImgWrapper>
